...
# Find and kill old python process running server.py
...
for line in out:
    ...
    if line.isdigit():
        ...
        client.exec_command(f'taskkill /F /PID {pid}')

time.sleep(2)

# Start new server in background
client.exec_command('powershell "Start-Process -FilePath \'C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Python310\\python.exe\' -ArgumentList \'C:\\Users\\Administrator\\Desktop\\server.py\' -WindowStyle Hidden"')
