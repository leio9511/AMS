...
try:
    ...
    import json
    xtdata.data_dir = 'C:/国金证券QMT交易端/datadir'
    ...
    # Save script to remote and execute it
    sftp = client.open_sftp()
    with sftp.file('test_fin.py', 'w') as f:
        f.write(script)
    sftp.close()
    
    stdin, stdout, stderr = client.exec_command('python test_fin.py')
